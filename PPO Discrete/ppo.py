...
class ActorNetwork(nn.Module):
    def __init__(self, n_actions, input_dims, alpha, fc1_dim=256, fc2_dims=256, chkpt_dir='tmp/ppo'):
        ...
        self.optimiser = optim.Adam(self.parameters(), lr=alpha, betas=(0.9, 0.999), eps=1e-08)
    ...
    def learn(self):
        for _ in range(self.n_epochs):
            ...
            for batch in batches:
                ...
                total_loss.backward()
                nn.utils.clip_grad_norm_(self.actor.parameters(), max_norm=0.5)  # Gradient clipping
